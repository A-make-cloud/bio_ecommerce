...
function Basket() {
    ...
    const { basket, getItemsWithDetails, removeOne, removeLine, addOneOfThis, getTotalTva, getTotalTtc } = useContext(BasketContext);
    ...
    function validate(){
        if (isLogged) navigate('/basket-summary')
                       ...
                       {basketSummary.map((articleType, i) => {
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        <Button variant="contained" sx={{ backgroundColor: "#FFB300", color: 'black' }} onClick={e => removeOne(articleType.id)}>En enlever un</Button>
